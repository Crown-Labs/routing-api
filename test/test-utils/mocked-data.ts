import { WBTC_MAINNET } from '@kittycorn-labs/smart-order-router'
import {
  DAI_MAINNET as DAI,
  USDC_MAINNET as USDC,
  USDT_MAINNET as USDT,
  WRAPPED_NATIVE_CURRENCY,
} from '@kittycorn-labs/smart-order-router/build/main/index'
import { V3PoolAccessor } from '@kittycorn-labs/smart-order-router/build/main/providers/v3/pool-provider'
